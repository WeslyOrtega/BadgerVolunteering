    ...
    <div className="flex justify-center items-center h-screen md:container md:mx-auto">
      <div className="w-full bg-slate-200 h-3/4 rounded-xl shadow-xl">
        <div className="flex flex-col items-center justify-center h-full w-full">
          <div className="text-center text-slate-600  "><h1 className='font-PlayfairDisplay text-5xl mb-10 md:text-6xl'>WELCOME TO BADGER</h1><p className='font-Poppins text-sm px-10 mb-7 md:mb-10 md:px-24 md:text-base'>Matching you to volunteer work that fits your personality.
</p></div>
